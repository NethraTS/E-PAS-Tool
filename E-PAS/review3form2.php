...
<div class="row mt">
<div class="col-lg-12">
<button type="button" class="btn btn-theme03 pull-left" onclick="window.location.href='review1list.php?active=r3'"><i class="fa fa-arrow-left"></i>&nbspReview 3 List</button>
</div>
</div>
...
?>
										...
										<br><br><br><br><br>
                 					<label class="col-sm-2 col-sm-2 control-label">Reviewer 2 Feedback</label>
                              <div class="col-sm-9">
<?php
...
?>		          
                              ...
                              <div class="col-sm-4">
<?php
echo '<div class="slider col-lg-5 green noslider green" id="r2sv" name="'.decrypt($d["overall R2rating"]).'"></div>';
?>		          
                              </div>
                               <br><br><br><br><br>                            
                              <label class="col-sm-2 col-sm-2 control-label">Reviewer 3 </label>
                              <div class="col-sm-4">
<?php
if($f==2)
{
echo '<div class="slider green col-lg-5 green" id="r3sv" name=""></div>';
}
if($f==3)
{
if(decrypt($d["overall R3rating"])==NULL)
echo '<div class="slider green col-lg-5 noslider green" id="r3sv" name=""></div>';
else 
echo '<div class="slider green col-lg-5 noslider green" id="r3sv" name="'.decrypt($d["overall R3rating"]).'"></div>';
}
if($f==4)
{
echo '<div class="slider green col-lg-5 noslider green" id="r3sv" name="'.decrypt($d["overall R3rating"]).'"></div>';
...
echo '<p class="form-control-static"><b><h4>Reviewer 3</h4></b></p>';
?>
<br>
<?php
if($f==2)
...
if($d["R2proposedAction"]["name"]==="promotion")
{	
echo '<input type="radio" name="radio" id="r1" checked="checked" value="promotion" onchange="change_promotion()">&nbsp&nbsp&nbsp<label for="r1">Propose a Promotion</label><br></br>';
echo '<div id="propose_promotion1" style="">';
}
else 
{
echo '<input type="radio" name="radio" id="r1" value="promotion" onchange="change_promotion()">&nbsp&nbsp&nbsp<label for="r1">Propose a Promotion</label><br></br>';
echo '<div id="propose_promotion1" style="">';
}
}
elseif($f==3)
...
if($d["R3proposedAction"]["name"]==="promotion")
{
echo '<option>'.$d["R3proposedAction"]["category"].'</option>';
foreach ($types['values'] as $type)
{
if($d["R3proposedAction"]["category"]==$type)
{}
else	
echo '<option>'.$type.'</option>';
}
...
{
if($d["R3proposedAction"]["name"]==="promotion")
echo '<option>'.$d["R3proposedAction"]["newPosition"].'</option>';
else
echo '<option>Proposed Position</option>';
}
elseif($f==4) 
...
{
if($d["R3proposedAction"]["name"]=="promotion")
echo '<textarea rows="3" cols="70" id="comments1">'.$d["R3proposedAction"]["comments"].'</textarea>';
else 
echo '<textarea rows="3" cols="70" id="comments1"></textarea>';
}
elseif($f==4)
...
{	
echo '<input type="radio" name="radio" id="r2" checked="checked" value="role_change" onchange="role_change()">&nbsp&nbsp&nbsp<label for="r2">Propose a Role Change</label><br></br>';
echo '<div id="propose_role_change1" style="">';
}
else 
{
echo '<input type="radio" name="radio" id="r2" value="role_change" onchange="role_change()">&nbsp&nbsp&nbsp<label for="r2">Propose a Role Change</label><br></br>';
echo '<div id="propose_role_change1" style="">';
}
}
elseif($f==3)
{
if($d["R3proposedAction"]["name"]==="role_change")
{
echo '<input type="radio" name="radio" id="r2" checked="checked" value="role_change" onchange="role_change()">&nbsp&nbsp&nbsp<label for="r2">Propose a Role Change</label><br></br>';
echo '<div id="propose_role_change1" style="">';
}
...
{
if($d["R3proposedAction"]["name"]=="role_change")
echo '<textarea rows="3" cols="70" id="comments2">'.$d["R3proposedAction"]["comments"].'</textarea>';
else 
echo '<textarea rows="3" cols="70" id="comments2"></textarea>';
}
elseif($f==4)
...
if($f==2)
{
	echo '<textarea rows="4" cols="70" maxlength="320" id="r3feedback"></textarea>';
}	
if($f==3)
{
	echo '<textarea rows="4" cols="70" maxlength="320" readonly="readonly" id="r3feedback">'.decrypt($d["r3 feedback"]).'</textarea>';
}	
if($f==4)
{
	echo '<textarea rows="4" cols="70" readonly="readonly" id="r3feedback">'.decrypt($d["r3 feedback"]).'</textarea>';
}	
?>
</div>
<?php
...
?>
<div class="col-lg-5">           
    <button type="button" class="btn btn-theme03 pull-right" onclick="review3form1()"><i class="fa fa-arrow-left"></i>Back</button> </div>
<br><br><br>
</div>
                ...
                <div class="modal-body">							              
                    <h4><center>The Employee Review has been submitted successfully!</center></h4>                    
                        <div class="modal-footer">
                   			<button type="button" class="btn btn-primary" name="ok" onclick="window.location.href='review1list.php?active=r3'">OK</button> 
                       </div>  
                </div>
            </div>
        </div>
...
var dsv = $("#r3sv").slider( "option", "value" ); //to get slider value
var radioValue=$("input[name='radio']:checked").val();

columnvalue[columnvalue.length]="<?php echo $psiid; ?>";
columnvalue[columnvalue.length]=v[dsv];
columnvalue[columnvalue.length]=$('#r3feedback').val();
