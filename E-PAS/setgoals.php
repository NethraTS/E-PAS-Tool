...
header('Location:setgoals1.php?eid='.$eid.'&status='.$status); 	
...
$doc=$c->findOne(array("id"=>$eid));
	...
	elseif($doc["flag"]=="1")
	{
		...
		{	 
			...
			echo '<td class="col-lg-1"><button class="btn btn-xs btn-info pull-right d" onclick=deletedesgn1(this,"del")><i class="fa fa-times"></i>&nbspDelete</td>';			
			echo '<td class="col-lg-1"></td>';			
			echo '</tr>';
			echo '<script type="text/javascript">' , 'update("$maxmd");'  , '</script>' ;
  	 	}
...
$doc=$c->findOne(array("id"=>$eid));
	...
	elseif($doc["flag"]=="1")
	{
		...
		{	 
			...
			echo '<td class="col-lg-1"><button class="btn btn-xs btn-info pull-right d" onclick=deletedesgn1(this,"qual")><i class="fa fa-times"></i>&nbspDelete</td>';			
			echo '<td class="col-lg-1"></td>';	
			echo '</tr>';
  			$dc++;
     	}   	         
...
$doc=$c->findOne(array("id"=>$eid)); 
	...
	elseif($doc["flag"]=="1")
	{
		...
		{	 
			...
			echo '<td class="col-lg-1"><button class="btn btn-xs btn-info pull-right d" onclick=deletedesgn1(this,"com")><i class="fa fa-times"></i>&nbspDelete</td>';			
			echo '<td class="col-lg-1"></td>';			
			echo '</tr>';
     	}   		      
    }
...
$doc=$c->findOne(array("id"=>$eid));
	...
	elseif($doc["flag"]=="1")
	{
		$maxmo=count($doc["OrgContribution"]);
		for($j=0;$j<$maxmo;$j++)
		{	 
			...
			echo '<td class="col-lg-1"><button class="btn btn-xs btn-info pull-right d" onclick=deletedesgn1(this,"org")><i class="fa fa-times"></i>&nbspDelete</td>';			
			echo '<td class="col-lg-1"></td>';		
			echo '</tr>';
     	}   	        
    }     
...
$doc=$c->findOne(array("id"=>$eid));
	...
	elseif($doc["flag"]=="1")
	{
		...
		echo '<td class="col-lg-1"><button class="btn btn-xs btn-info pull-right d" onclick=deletedesgn1(this,"val")><i class="fa fa-times"></i>&nbspDelete</td>';			
			echo '<td class="col-lg-1"></td>';			
			echo '</tr>';
     	}   	      
    }
	...
	elseif($doc["flag"]=="1")
	{
		...
		{	 
      	...
      	echo '<option>'.($doc["training"][$j]["train-quater"]).'</option>';
	   	...
	   	echo '</select></td>';			
			echo '<td class="col-lg-1"><button class="btn btn-xs btn-info pull-right d" onclick=deletedesgn1(this,"train")><i class="fa fa-times"></i>&nbspDelete</td>';			
			echo '</tr>';
     	}   	      
    }
    	elseif($doc["flag"]=="2")
...
var inc6=61;
//if(<?php echo $maxmd; ?>)
var maxmd=<?php echo $maxmd; ?>;

var maxmq=<?php echo $maxmq; ?>;
var maxmc=<?php echo $maxmc; ?>;
var maxmo=<?php echo $maxmo; ?>;
var maxmv=<?php echo $maxmv; ?>;
var maxmt=<?php echo $maxmt; ?>;
var defaultTextAreaCount=0;
var defaultTextAreaCount1=0;
var t1;
...
inc6=62;	 	
	  ...
	  if(dw>0&&inc1<=11)
	  {
	 	 alert("Deliverable1 not set");return false;
		}	   
	   else if(qw>0&&inc2<=21)
	   {
	  alert("Quality not set");return false;
