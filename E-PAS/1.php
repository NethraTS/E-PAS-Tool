...
$eid=$_GET['eid'];
$doc=$c->findOne(array("id"=>$eid));
echo '<input type="number" class="col-lg-1 ac weight" size="10" id="dWt" onchange="validate_weight(this.value,'.$doc["gWts"]["del"].',ocWt)" onkeypress="return isNumberKey(event)" onkeyup="validate_weight(this.value,'.$doc["gWts"]["del"].',dWt)" value="'.$doc["gWts"]["del"].'"></input></b>';
...
$eid=$_GET['eid'];
$doc=$c->findOne(array("id"=>$eid));
 echo '<input type="number" class="col-lg-1 ac weight" size="10" id="qWt" onchange="validate_weight(this.value,'.$doc["gWts"]["qual"].',qWt)" onkeypress="return isNumberKey(event)" onkeyup="validate_weight(this.value,'.$doc["gWts"]["qual"].',qWt)" value="'.$doc["gWts"]["qual"].'"></input></b>';
...
$eid=$_GET['eid'];
$doc=$c->findOne(array("id"=>$eid));
echo '<input type="number" class="col-lg-1 ac weight" size="10" id="cWt" onchange="validate_weight(this.value,'.$doc["gWts"]["comp"].',cWt)" onkeypress="return isNumberKey(event)" onkeyup="validate_weight(this.value,'.$doc["gWts"]["comp"].',cWt)" value="'.$doc["gWts"]["comp"].'"></input></b>';
...
$eid=$_GET['eid'];
$doc=$c->findOne(array("id"=>$eid));
echo '<input type="number" class="col-lg-1 ac weight" size="10" id="ocWt" onchange="validate_weight(this.value,'.$doc["gWts"]["orgcont"].',ocWt)" onkeypress="return isNumberKey(event)" onkeyup="validate_weight(this.value,'.$doc["gWts"]["orgcont"].',vaWt)" value="'.$doc["gWts"]["orgcont"].'"></input></b>';
...
$eid=$_GET['eid'];
$doc=$c->findOne(array("id"=>$eid));
echo '<input type="number" class="col-lg-1 ac weight" size="10" id="vaWt" onchange="validate_weight(this.value,'.$doc["gWts"]["valadd"].',vaWt)" onkeypress="return isNumberKey(event)" onkeyup="validate_weight(this.value,'.$doc["gWts"]["valadd"].',vaWt)" value="'.$doc["gWts"]["valadd"].'"></input></b>';
