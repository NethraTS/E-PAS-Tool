...
{    
echo '<label class="col-sm-2 col-sm-2 control-label">Comments :</label>';
echo '<p class="form-control-static col-lg-4">'.$d["R2proposedAction"]["comments"].'</p>';
}
?>
...
echo '<label class="col-sm-12 control-label"><b>REVIEWER 3-PROPOSED ACTION&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspPROMOTION</b></label>';
elseif($d["R3proposedAction"]["name"]==="role_change")
echo '<label class="col-sm-12 control-label"><b>REVIEWER 3-PROPOSED ACTION&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspROLE CHANGE</b></label>';
else 
echo '<label class="col-sm-12 control-label"><b>REVIEWER 3-PROPOSED ACTION&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp-</b></label>';
...
echo '<br>';
echo '<label class="col-sm-2 col-sm-2 control-label">Comments :</label>';
echo '<p class="form-control-static col-lg-8">'.$d["R3proposedAction"]["comments"].'</p>';
}
?>
										<br><br><br><br><br> 
                              </form>                
