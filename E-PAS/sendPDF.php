...
$filename = $e_name."_".$e_id.".pdf";
   
$attachdata = $pdf->Output('','S'); //  return the document as a string (name is ignored)	
...
$subject="Employee Exit Feedback form";
$message="<p>Hello , <br><br>

Employee Exit formality has been completed for ".$e_name."-".$eid.". 
<br><br>
Please review it and provide your comments for further process.
<br><br><br><br>
...
$to= "rajani@paxterrasolutions.com";
...
if($mail->Send())
 {
	echo "mail sent";
	 ...
	 header('Location: relievingProcess2.php');
	 echo "<script>
