...
elseif($ef<="2")
	...
	echo '<li class="active"><a data-toggle="tab" href="#r1">My Team</a></li>';
	echo '<li ><a data-toggle="tab" href="#r2">Second level</a></li>';
	echo '<li class="active"><a data-toggle="tab" href="#r1">Feedback History</a></li>';
	}
...
?>	
	...
	<!--<input type="text" value="" id="datetimepicker_mask"/><br><br>-->  
                 <table class="table" id="rev1" data-page-length='100'>
		                        <thead>                       
		                               <tr>
...
if($doc['flag']<1)
{			
				echo '<button type="button"  class="btn bc btn-primary btn-xs" onclick="modify(this)" >
			 		  <i class="fa fa-edit"></i>&nbsp&nbsp Reschedule
							 		</button>';
	}				}
					else {
...
if((selected)<("2017/02/28 24:00"))
{
          alert("hi");  
            $.ajax({ 
   	       
				url:'Managernotify.php', 
				type:'POST', 
