...
<div class="row mt">
<div class="col-lg-12">
<button type="button" class="btn btn-theme03 pull-left" onclick="window.location.href='hrviewlist.php'"><i class="fa fa-arrow-left"></i>&nbspBack</button>
</div>
</div>
...
if($f==2 || $f==3)
{
	...
	{ 
     if($d["appraisal"][$j]["parameter"]=="deliverables")
     {
  	   ...
  	   echo '<td><textarea readonly="readonly" rows="6" cols="35">'.$d["appraisal"][$j]["goal"].'</textarea></td>';
  	   echo '<td><textarea readonly="readonly" rows="6" cols="35">'.$d["appraisal"][$j]["accomplishment"].'</textarea></td>';
if($f==2)
echo '<td><textarea readonly="readonly" rows="6" cols="40">'.$d["appraisal"][$j]["reviewer1comment"].'</textarea></td>';		
		$dc++;  			
  			}
   }
	echo '</tbody>';
...
echo '<div class="saslider col-lg-2 noslider green" id="dsv" name="'.$d["selfRatings"]["deliverables"].'"></div>';
echo '<br><br><br>';
if($f==2)
{
echo '<label class="col-lg-2 pull-left">Reviewer 1 Rating</label>';
echo '<div class="slider col-lg-2 noslider green" id="r1dsv" name="'.$d['reviewer1Ratings']['deliverables'].'"></div>';
}
}
elseif($f==1)
{
...
echo '<label class="col-lg-2 pull-left">Self-Rating</label>';
echo '<div class="saslider col-lg-2 noslider green" id="qsv" name="'.$d["selfRatings"]["quality"].'"></div>';
echo '<br><br><br>';
if($f==2)
{
echo '<label class="col-lg-2 pull-left">Reviewer 1 Rating</label>';
echo '<div class="slider col-lg-2 noslider green" id="r1qsv" name="'.$d['reviewer1Ratings']['quality'].'"></div>';
}
}
elseif($f==1)
{
...
echo '<label class="col-lg-2 pull-left">Self-Rating</label>';
echo '<div class="saslider col-lg-2 noslider green" id="csv" name="'.$d["selfRatings"]["competency"].'"></div>';
echo '<br><br><br>';
if($f==2)
{
echo '<label class="col-lg-2 pull-left">Reviewer 1 Rating</label>';
echo '<div class="slider col-lg-2 noslider green" id="r1csv" name="'.$d['reviewer1Ratings']['competency'].'"></div>';
}
}
elseif($f==1)
{
...
if($f==2 || $f==3)
{
	...
	{ 
     if($d["appraisal"][$j]["parameter"]=="organisational contribution")
     {
  	   ...
  	   echo '<td><textarea readonly="readonly" rows="6" cols="30">'.$d["appraisal"][$j]["goal"].'</textarea></td>';
  	   echo '<td><textarea readonly="readonly" rows="6" cols="30">'.$d["appraisal"][$j]["accomplishment"].'</textarea></td>';
if($f==2)
echo '<td><textarea readonly="readonly" rows="6" cols="40">'.$d["appraisal"][$j]["reviewer1comment"].'</textarea></td>';		
		$dc++;  			
  			}
...
echo '<label class="col-lg-2 pull-left">Self-Rating</label>';
echo '<div class="saslider col-lg-2 noslider green" id="ocsv" name="'.$d["selfRatings"]["organisationalContribution"].'"></div>';
echo '<br><br><br>';
if($f==2)
{
echo '<label class="col-lg-2 pull-left">Reviewer 1 Rating</label>';
echo '<div class="slider col-lg-2 noslider green" id="r1ocsv" name="'.$d['reviewer1Ratings']['organisationalContribution'].'"></div>';
}
}
elseif($f==1)
{
...
echo '<label class="col-lg-2 pull-left">Self-Rating</label>';
echo '<div class="saslider col-lg-2 noslider green" id="vasv" name="'.$d["selfRatings"]["valueAddition"].'"></div>';
echo '<br><br><br>';
if($f==2)
{
echo '<label class="col-lg-2 pull-left">Reviewer 1 Rating</label>';
echo '<div class="slider col-lg-2 noslider green" id="r1vasv" name="'.$d['reviewer1Ratings']['valueAddition'].'"></div>';
}
}
elseif($f==1)
{
...
<div class="col-lg-5">
<button type="button" class="btn btn-theme03 pull-right" onclick="hrviewform2()"><i class="fa fa-arrow-right"></i>&nbspNext</button> 
</div>
</div>
...
<script type="text/javascript" >
function hrviewform2()
{
var empid="<?php echo $psiid;?>";
window.location.href="hrviewform2.php?eid="+empid;	
}
</script>  
<script type="text/javascript" >
function check()
