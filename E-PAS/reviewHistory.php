...
$name=$_SESSION["uname"];
//echo $role;
$d1=$c->findOne(array("psiid"=>$psiid));
$flg2=$d1["flag2"];
$r1name=$n["r1name"];
$active=$_GET["active"];
if(!empty($active))
...
if($activeRole=="r1")
{
	...
	{
	echo '<li class="active" ><a data-toggle="tab" href="#emp">My History</a></li>';		
	echo '<li   ><a data-toggle="tab" href="#review1">Team History </a></li>';
	}
	else if($_GET['r1']=="review1")
	{
	echo '<li ><a data-toggle="tab" href="#emp">My History</a></li>';		
	echo '<li  class="active"><a data-toggle="tab" href="#review1">Team History </a></li>';
...
if($activeRole=="emp")
{
	echo "<div id='emp' class='tab-pane active '>";
}
else if($activeRole=="r1")
{
	if($_GET['r1']=="emp")
	{
	echo '<div id="emp" class="tab-pane active">';
	...
	{
	echo '<div id="emp" class="tab-pane ">';		
	}else
	{
	echo '<div id="emp" class="tab-pane active">';
	}
...
?>
  <table  class="table table-striped">
                  <thead >
                  <th  >Review Year</th><th>R1 Name</th><th>R2 Name</th><th >Self Rating</th><th >Normalized Rating</th><th>View </th><thead>
                  <tbody>
						<?php
					...
					<!--	<td><?php echo $v['r1id']; ?></td> -->
						...
						<td><?php echo decrypt($v['overallselfrating']) ?></td>
						<td><?php echo decrypt($v['normalisedRating']) ?></td>
...
if($activeRole=="r1")
{
	...
	{
	echo '<div id="review1" class="tab-pane active">';		
	}
	else
	{
	echo '<div id="review1" class="tab-pane">';		
...
?>
 ...
 <table class="table" id="rev1">
						...
						<a href="historyView.php?emp=<?php echo $encPsiid ?>&year=<?php echo $encYear; ?>&r1=true"><?php echo $v['year']; ?></a>
